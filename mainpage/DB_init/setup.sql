...
CREATE TABLE teamTodo (
  idx int UNSIGNED NOT NULL AUTO_INCREMENT,
  teamId int NOT NULL,
  contents varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  
  createDate varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  creatorId int NOT NULL,
  creatorName varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  creatorTeamId int NOT NULL

  updaterId varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  updateDate varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  updaterName varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  updaterTeamId int NOT NULL

  startDate varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  endDate varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
